...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d8092bbb-40a6-4546-b40d-512f7bf09844",
...
function loadDatabaseAdapter(config) {
  ...
  if (!db) {
    if (["nitro-prerender", "nitro-dev"].includes("netlify")) {
...
export { withLeadingSlash as A, parseURL as B, encodePath as C, encodeParam as D, parseQuery as E, withTrailingSlash as F, withoutTrailingSlash as G, serialize$1 as H, isEqual as I, hash$1 as J, useRuntimeConfig as a, buildAssetsURL as b, getResponseStatusText as c, getResponseStatus as d, defineRenderHandler as e, getQuery as f, getRouteRulesForPath as g, createError$1 as h, getRouteRules as i, joinHeaders as j, createHooks as k, getContext as l, createRouter$1 as m, normalizeCookieHeader as n, defu as o, publicAssetsURL as p, hasProtocol as q, joinURL as r, sanitizeStatusCode as s, toRouteMatcher as t, useNitroApp as u, isScriptProtocol as v, withQuery as w, executeAsync as x, defuFn as y, klona as z };
