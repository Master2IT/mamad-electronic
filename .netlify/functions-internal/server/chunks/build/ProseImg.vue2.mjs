...
import { A as withLeadingSlash, F as withTrailingSlash, r as joinURL } from '../_/nitro.mjs';
import { p as useRuntimeConfig, a as __nuxt_component_3 } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(__nuxt_component_3)), mergeProps({
