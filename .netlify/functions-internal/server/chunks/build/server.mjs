import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, unref, ref, nextTick, defineComponent, onServerPrefetch, h, mergeProps, useSSRContext, useAttrs, provide, watch, withCtx, createVNode, resolveDynamicComponent, renderSlot, createBlock, openBlock, toDisplayString, toValue, resolveComponent, useSlots, createCommentVNode, Fragment, createTextVNode, withModifiers, renderList, markRaw, useId, Suspense, onErrorCaptured, createApp } from 'vue';
import { k as createHooks, l as getContext, h as createError$1, t as toRouteMatcher, m as createRouter, o as defu, q as hasProtocol, r as joinURL, w as withQuery, s as sanitizeStatusCode, v as isScriptProtocol, x as executeAsync, y as defuFn, z as klona, A as withLeadingSlash, B as parseURL, C as encodePath, D as encodeParam, E as parseQuery, F as withTrailingSlash, G as withoutTrailingSlash, H as serialize, I as isEqual } from '../_/nitro.mjs';
...
import { useForwardProps, Primitive, Slot, useForwardPropsEmits, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider } from 'reka-ui';
...
const _routes = [
  ...
  },
  {
    name: "panel-gifts",
    path: "/panel/gifts",
    component: () => import('./gifts.vue.mjs')
  },
  {
    name: "panel",
    path: "/panel",
  ...
  },
  {
    name: "checkOut-card",
    path: "/checkOut/card",
    component: () => import('./card.vue2.mjs')
  },
  {
    name: "panel-profile",
    path: "/panel/profile",
  ...
  },
  {
    name: "panel-wishList",
    path: "/panel/wishList",
    component: () => import('./wishList.vue.mjs')
  },
  {
    name: "shop-products-_id",
    path: "/shop/products/_id",
    component: () => import('./_id.vue.mjs')
  },
  {
    name: "shop-products",
    path: "/shop/products",
...
const __nuxt_component_3$1 = Object.assign(_sfc_main$b, { __name: "NuxtImg" });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (_ctx.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(__nuxt_component_3$1)), mergeProps({
                role: "img",
                src: _ctx.src,
                alt: _ctx.alt,
                width: sizePx.value,
            ...
            return [
              _ctx.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(__nuxt_component_3$1)), mergeProps({
                key: 0,
                role: "img",
                src: _ctx.src,
                alt: _ctx.alt,
...
const __nuxt_component_1$2 = Object.assign(_sfc_main$a, { __name: "UAvatar" });
...
const theme$2 = {
  ...
  "compoundVariants": [
    ...
    },
    {
      "color": "tertiary",
      "variant": "solid",
      "class": "text-(--ui-bg) bg-(--ui-tertiary) hover:bg-(--ui-tertiary)/75 disabled:bg-(--ui-tertiary) aria-disabled:bg-(--ui-tertiary) focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--ui-tertiary)"
    },
    {
      "color": "info",
      "variant": "solid",
    ...
    },
    {
      "color": "tertiary",
      "variant": "outline",
      "class": "ring ring-inset ring-(--ui-tertiary)/50 text-(--ui-tertiary) hover:bg-(--ui-tertiary)/10 disabled:bg-transparent aria-disabled:bg-transparent dark:disabled:bg-transparent dark:aria-disabled:bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-(--ui-tertiary)"
    },
    {
      "color": "info",
      "variant": "outline",
    ...
    },
    {
      "color": "tertiary",
      "variant": "soft",
      "class": "text-(--ui-tertiary) bg-(--ui-tertiary)/10 hover:bg-(--ui-tertiary)/15 focus:outline-none focus-visible:bg-(--ui-tertiary)/15 disabled:bg-(--ui-tertiary)/10 aria-disabled:bg-(--ui-tertiary)/10"
    },
    {
      "color": "info",
      "variant": "soft",
    ...
    },
    {
      "color": "tertiary",
      "variant": "subtle",
      "class": "text-(--ui-tertiary) ring ring-inset ring-(--ui-tertiary)/25 bg-(--ui-tertiary)/10 hover:bg-(--ui-tertiary)/15 disabled:bg-(--ui-tertiary)/10 aria-disabled:bg-(--ui-tertiary)/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-(--ui-tertiary)"
    },
    {
      "color": "info",
      "variant": "subtle",
    ...
    },
    {
      "color": "tertiary",
      "variant": "ghost",
      "class": "text-(--ui-tertiary) hover:bg-(--ui-tertiary)/10 focus:outline-none focus-visible:bg-(--ui-tertiary)/10 disabled:bg-transparent aria-disabled:bg-transparent dark:disabled:bg-transparent dark:aria-disabled:bg-transparent"
    },
    {
      "color": "info",
      "variant": "ghost",
    ...
    },
    {
      "color": "tertiary",
      "variant": "link",
      "class": "text-(--ui-tertiary) hover:text-(--ui-tertiary)/75 disabled:text-(--ui-tertiary) aria-disabled:text-(--ui-tertiary) focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-(--ui-tertiary)"
    },
    {
      "color": "info",
      "variant": "link",
                    ...
                    renderSlot(_ctx.$slots, "leading", {}, () => {
                      ...
                      return [
                        unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(UIcon, {
                          ...
                          name: unref(leadingIconName),
                          class: ui.value.leadingIcon({ class: (_a4 = props.ui) == null ? void 0 : _a4.leadingIcon, active })
                        }, null, 8, ["name", "class"])) : !!_ctx.avatar ? (openBlock(), createBlock(__nuxt_component_1$2, mergeProps({
                          key: 1,
                          size: ((_b2 = props.ui) == null ? void 0 : _b2.leadingAvatarSize) || ui.value.leadingAvatarSize()
                        }, _ctx.avatar, {
                          class: ui.value.leadingAvatar({ class: (_c = props.ui) == null ? void 0 : _c.leadingAvatar, active })
...
const __nuxt_component_3 = Object.assign(_sfc_main$7, { __name: "UButton" });
...
const theme$1 = {
  ...
  "variants": {
    "color": {
      ...
      "tertiary": {
        "root": "focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-(--ui-tertiary)",
        "icon": "text-(--ui-tertiary)",
        "progress": "bg-(--ui-tertiary)"
      },
      "info": {
        ...
        default: withCtx(({ remaining, duration }, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "leading", {}, () => {
              var _a4, _b2, _c2;
              if (_ctx.avatar) {
                _push2(ssrRenderComponent(__nuxt_component_1$2, mergeProps({
              ...
              ssrRenderSlot(_ctx.$slots, "actions", {}, () => {
                ...
                ssrRenderList(_ctx.actions, (action, index) => {
                  _push2(ssrRenderComponent(unref(ToastAction), {
                    ...
                    default: withCtx((_, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(ssrRenderComponent(__nuxt_component_3, mergeProps({
                          size: "xs",
                          color: _ctx.color,
                          ref_for: true
                        ...
                        return [
                          createVNode(__nuxt_component_3, mergeProps({
                            size: "xs",
                            color: _ctx.color,
                            ref_for: true
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => {
                          var _a4;
                          return [
                            _ctx.close ? (openBlock(), createBlock(__nuxt_component_3, mergeProps({
                              key: 0,
                              icon: _ctx.closeIcon || unref(appConfig).ui.icons.close,
                              size: "md",
                              color: "neutral",
            ...
            return [
              renderSlot(_ctx.$slots, "leading", {}, () => {
                var _a4, _b2, _c2;
                return [
                  _ctx.avatar ? (openBlock(), createBlock(__nuxt_component_1$2, mergeProps({
                    key: 0,
                    size: ((_a4 = props.ui) == null ? void 0 : _a4.avatarSize) || ui.value.avatarSize()
                  }, _ctx.avatar, {
                    class: ui.value.avatar({ class: (_b2 = props.ui) == null ? void 0 : _b2.avatar })
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        { name: "description", content: "Your premier electronics shop" },
...
export { server as A, LayoutMetaSymbol as L, PageRouteSymbol as P, UIcon as U, __nuxt_component_1$1 as _, __nuxt_component_3$1 as a, useAppConfig as b, useLocale as c, __nuxt_component_3 as d, _appConfig as e, buttonGroupInjectionKey as f, get as g, useRoute as h, __nuxt_component_2 as i, __nuxt_component_1$2 as j, useNuxtApp as k, appLayoutTransition as l, _wrapInTransition as m, fetchDefaults as n, useAsyncData as o, useRuntimeConfig as p, useFormField as q, useButtonGroup as r, useComponentIcons as s, tv as t, useHead as u, looseToNumber as v, isArrayOfArray as w, ULink as x, pickLinkProps as y, ULinkBase as z };
