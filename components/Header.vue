          ...
          >
            ...
            <div class="hidden items-center justify-between gap-4 md:flex">
              ...
              >
                ...
                <template #content>
                  <div
                    class="w-96 overflow-hidden rounded-lg bg-white shadow-xl"
                  >
                    <!-- Header -->
                    <div
                      class="from-primary-500 to-primary-600 bg-gradient-to-r px-6 py-4"
                    >
                    ...
                    <div v-else class="px-4 py-2">
                      <div
                        class="custom-scrollbar max-h-80 space-y-3 overflow-y-auto"
                      >
                        <div
