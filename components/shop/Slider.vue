<template>
    <div class="grid grid-cols-1 md:grid-cols-8 md:gap-3 mt-5 h-auto md:h-[410px]">
        <div class="col-span-1 md:col-span-6">
            <NuxtImg class="w-full h-[200px] md:h-[410px] rounded-md object-cover"
        ...
        <div class="col-span-2 md:flex-col gap-4 mt-0 hidden md:flex">
            <NuxtImg class="h-[150px] md:h-[197px] w-full rounded-md object-cover"
